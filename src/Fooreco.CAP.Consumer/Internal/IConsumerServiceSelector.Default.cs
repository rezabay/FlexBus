...
namespace Fooreco.CAP.Consumer.Internal
{
    /// <inheritdoc />
    /// <summary>
    /// A default <see cref="T:Fooreco.CAP.Abstractions.IConsumerServiceSelector" /> implementation.
    /// </summary>
    public class ConsumerServiceSelector : IConsumerServiceSelector
    {
            ...
            IServiceProvider provider)
        {
            ...
            foreach (var service in ConsumerOptionsExtension.ServiceCollection.Where(o => o.ImplementationType != null && o.ServiceType != null))
            {
